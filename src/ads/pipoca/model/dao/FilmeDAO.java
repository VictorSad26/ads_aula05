...
public class FilmeDAO {
	...
	public Filme atualizarFilme(Filme filme) throws IOException {
		...
		String sql = "UPDATE filme "
				+ "SET titulo = ?,descricao = ?, diretor =?, posterpath = ?, popularidade = ?, data_lancamento = ?, id_genero= ? " // Você tinha que terminar com espaço aqui, na concatenação acabom ficando id_genero = ?WHERE id.. colado
				+ "WHERE id= ?";
